...
class Dagger:
    def __init__(self, env, config, summaries_dir, nn_dir):
        ...
        self.local_rank = 0  # local rank of the process
        ...
        self.student_model_ddp = DDP(self.student_model, device_ids=[0], find_unused_parameters=True)
        ...
        wp.init()
        self.depth_aug = DepthAug(f"cuda:0")
